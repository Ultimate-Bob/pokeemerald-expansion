...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_BIDOOF_PERFECT] =
    {
        ...
        .cryId = CRY_BIDOOF_PERFECT,
        .natDexNum = NATIONAL_DEX_BIDOOF,
        .categoryName = _("Perfect"),
        .height = 65,
        .weight = 920,
        .description = COMPOUND_STRING( // 153 line len
            "Should not exist, yet does.\n"
            "Reality exceeded the critical threshold.\n"
            "A flash of light converges to perfection.\n"
            "This world will never be the same again."),
        .pokemonScale = 256, // These seem to be fixed point 256/x decimals
        .pokemonOffset = 0,
        .trainerScale = 940,
        .trainerOffset = 22,
        ...
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        .palette = gMonPalette_BidoofPerfect,
