...
// ---
static const u8 sText_WildPkmnShinyAppeared[] = _("You encountered a Shiny {B_OPPONENT_MON1_NAME}!\nPress B to send out a POKéMON!\p");
static const u8 sText_LegendaryPkmnShinyAppeared[] = _("You encountered a Shiny {B_OPPONENT_MON1_NAME}!\nPress B to send out a POKéMON!\p");
static const u8 sText_TwoWildPkmnShinyMon1Appeared[] = _("Oh! A Shiny {B_OPPONENT_MON1_NAME} and\n{B_OPPONENT_MON2_NAME} appeared!\pPress B to send out a POKéMON!\p");
static const u8 sText_TwoWildPkmnShinyMon2Appeared[] = _("Oh! A wild {B_OPPONENT_MON1_NAME} and\nShiny {B_OPPONENT_MON2_NAME} appeared!\pPress B to send out a POKéMON!\p");
static const u8 sText_TwoWildPkmnShinyMons1And2Appeared[] = _("Oh! A Shiny {B_OPPONENT_MON1_NAME} and\nShiny {B_OPPONENT_MON2_NAME} appeared!\pPress B to send out a POKéMON!\p");
// ---
...
void BufferStringBattle(u16 stringID, u32 battler)
{
    ...
    case STRINGID_INTROMSG: // first battle msg
        ...
        else
        {
            ...
            else if (IsDoubleBattle() && IsValidForBattle(&gEnemyParty[gBattlerPartyIndexes[GetBattlerAtPosition(B_POSITION_OPPONENT_RIGHT)]])) // interesting, looks like they had something planned for wild double battles
            { 
