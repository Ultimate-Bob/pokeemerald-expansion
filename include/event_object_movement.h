...
u8 GetForceFaceDirectionMovementAction(u32);
...
void MovementType_ForceRotateCounterclockwise(struct Sprite *sprite);
void MovementType_ForceRotateClockwise(struct Sprite *sprite);
void MovementType_FacePlayer(struct Sprite *sprite);
...
// start feature/enhanced-movement
u8 MovementType_ForceRotateCounterclockwise_Step0(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_ForceRotateCounterclockwise_Step1(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_ForceRotateCounterclockwise_Step2(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_ForceRotateCounterclockwise_Step3(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_ForceRotateClockwise_Step0(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_ForceRotateClockwise_Step1(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_ForceRotateClockwise_Step2(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_ForceRotateClockwise_Step3(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_FacePlayer_Step0(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_FacePlayer_Step1(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_FacePlayer_Step2(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_FacePlayer_Step3(struct ObjectEvent *objectEvent, struct Sprite *sprite);
// end feature/enhanced-movement
