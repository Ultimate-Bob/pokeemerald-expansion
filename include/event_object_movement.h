...
u8 MovementType_ForceRotateCounterclockwise_Step0(struct ObjectEvent *, struct Sprite *);
u8 MovementType_ForceRotateCounterclockwise_Step1(struct ObjectEvent *, struct Sprite *);
u8 MovementType_ForceRotateCounterclockwise_Step2(struct ObjectEvent *, struct Sprite *);
u8 MovementType_ForceRotateCounterclockwise_Step3(struct ObjectEvent *, struct Sprite *);
u8 MovementType_ForceRotateClockwise_Step0(struct ObjectEvent *, struct Sprite *);
...
u8 MovementType_FacePlayer_Step1(struct ObjectEvent *, struct Sprite *);
u8 MovementType_FacePlayer_Step2(struct ObjectEvent *, struct Sprite *);
u8 MovementType_FacePlayer_Step3(struct ObjectEvent *, struct Sprite *);
