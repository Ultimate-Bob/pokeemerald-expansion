...
#define MOVEMENT_ACTION_FORCE_FACE_DOWN                 (ENHANCED_MOVEMENT_ACTIONS_START + 0)  // 0xB2
#define MOVEMENT_ACTION_FORCE_FACE_UP                   (ENHANCED_MOVEMENT_ACTIONS_START + 1)  // 0xB3
#define MOVEMENT_ACTION_FORCE_FACE_LEFT                 (ENHANCED_MOVEMENT_ACTIONS_START + 2)  // 0xB4
#define MOVEMENT_ACTION_FORCE_FACE_RIGHT                (ENHANCED_MOVEMENT_ACTIONS_START + 3)  // 0xB5
#define MOVEMENT_ACTION_FACE_OBJECT                     (ENHANCED_MOVEMENT_ACTIONS_START + 4)  // 0xB6
#define MOVEMENT_ACTION_FACE_AWAY_OBJECT                (ENHANCED_MOVEMENT_ACTIONS_START + 5)  // 0xB7
#define MOVEMENT_ACTION_WALK_IN_PLACE                   (ENHANCED_MOVEMENT_ACTIONS_START + 6)  // 0xB8
#define MOVEMENT_ACTION_WALK_FORWARD                    (ENHANCED_MOVEMENT_ACTIONS_START + 7)  // 0xB9
#define MOVEMENT_ACTION_WALK_BACKWARD                   (ENHANCED_MOVEMENT_ACTIONS_START + 8)  // 0xBA
