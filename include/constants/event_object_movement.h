...
// start feature/enhanced-movement
#define NORMAL_MOVEMENT_ACTIONS_END                     (MOVEMENT_ACTION_SPIN_RIGHT) // 0xB5

#define ENHANCED_MOVEMENT_ACTIONS_START                 (NORMAL_MOVEMENT_ACTIONS_END + 1) // 0xB6
#define MOVEMENT_ACTION_FORCE_FACE_DOWN                 (ENHANCED_MOVEMENT_ACTIONS_START + 0)  // 0xB7
#define MOVEMENT_ACTION_FORCE_FACE_UP                   (ENHANCED_MOVEMENT_ACTIONS_START + 1)  // 0xB8
#define MOVEMENT_ACTION_FORCE_FACE_LEFT                 (ENHANCED_MOVEMENT_ACTIONS_START + 2)  // 0xB9
#define MOVEMENT_ACTION_FORCE_FACE_RIGHT                (ENHANCED_MOVEMENT_ACTIONS_START + 3)  // 0xBA
#define MOVEMENT_ACTION_FACE_OBJECT                     (ENHANCED_MOVEMENT_ACTIONS_START + 4)  // 0xBB
#define MOVEMENT_ACTION_FACE_AWAY_OBJECT                (ENHANCED_MOVEMENT_ACTIONS_START + 5)  // 0xBC
#define MOVEMENT_ACTION_WALK_IN_PLACE                   (ENHANCED_MOVEMENT_ACTIONS_START + 6)  // 0xBD
#define MOVEMENT_ACTION_WALK_FORWARD                    (ENHANCED_MOVEMENT_ACTIONS_START + 7)  // 0xBE
#define MOVEMENT_ACTION_WALK_BACKWARD                   (ENHANCED_MOVEMENT_ACTIONS_START + 8)  // 0xBF

#define ENHANCED_MOVEMENT_ACTIONS_END                   (MOVEMENT_ACTION_WALK_BACKWARD) // 0xBF
// end feature/enhanced-movement
