...
// start feature/custom-transitions-battlemusic
#define VAR_TEMP_CUSTOM_BATTLE_MUSIC        VAR_TEMP_0
#define VAR_TEMP_CUSTOM_TRANSITION          VAR_TEMP_1
// end feature/custom-transitions-battlemusic
